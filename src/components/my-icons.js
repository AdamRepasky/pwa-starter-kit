...
export const homeIcon = html`<svg height="24" viewBox="0 0 24 24" width="24"><path d="M20,20v-8h2v0L12,3L2,12v0h2v8c0,0.6,0.4,1,1,1h5v-7h4v7h5C19.6,21,20,20.6,20,20z"/></svg>`;
